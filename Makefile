...
smdk2410_config	:	unconfig
	@mkdir -p $(obj)include $(obj)board/samsung/smdk2410
	@mkdir -p $(obj)nand_spl/board/samsung/smdk2410
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "RAM_TEXT = 0x33000000" >> $(obj)board/samsung/smdk2410/config.tmp
